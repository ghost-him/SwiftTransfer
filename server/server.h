...
public:
    ...
    Status getFileList(ServerContext* context, const GetFileListPage* getFileListPage, FileList* writer) override ;
    ...
    Status endSendUploadFile(ServerContext* context, const EndTransfer* endTransfer, Placeholder* placeholder) override ;
